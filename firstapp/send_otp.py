...
# from . models import *
# import random
# def send_email_otp(request, username ,user_email):
...
#     message = f'Your OTP code is: {otp}\n Click Here to verify your otp link ----->  {scheme}://{host}/validate'
...
#     try:
#         otp_record = OTP.objects.get(author=username)
...
#         otp_record = OTP(author=username, OTP_digit=otp, expiry_time=expiry_time)
#         otp_record.save()
